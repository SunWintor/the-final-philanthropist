...
CREATE TABLE `tfp_user_game_history` (
                                         ...
                                         `end_money` int(11) NOT NULL DEFAULT '' COMMENT '游戏结束时剩余的金钱',
                                         `rank` int(11) NOT NULL DEFAULT '' COMMENT '本局排名',
                                         `ranking` int(11) NOT NULL DEFAULT '' COMMENT '本局获得了多少排位分',
                                         `ctime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '创建时间',
                                         `mtime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                         PRIMARY KEY (`id`),
...
CREATE TABLE `tfp_user_rank` (
                                         ...
                                         `ranking` int(11) NOT NULL DEFAULT '' COMMENT '排位分',
                                         `ver` int(11) NOT NULL COMMENT '版本号，用于幂等',
                                         `ctime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP  COMMENT '创建时间',
                                         `mtime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                         PRIMARY KEY (`id`),
